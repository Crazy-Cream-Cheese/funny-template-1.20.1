...
public class ModItemGroup {
    ...
    public static final ItemGroup Funny_Group = Registry.register(Registries.ITEM_GROUP, new Identifier(Funny.MOD_ID,"funny_group"), FabricItemGroup.builder().displayName(Text.translatable("itemGroup.funny_group")).icon(()-> new ItemStack(ModItems.FUNNY)).entries((displayContext, entries) -> {
        //注册一个fart物品组
        // 添加物品到物品组中
