...
public class ModItems {
    ...
    public static final Item Lemon_Iced_Tea_Core = registerItems("lemon_iced_tea_core",new Item(new FabricItemSettings().food(ModFoodComponents.RedTea).maxCount(16)));
